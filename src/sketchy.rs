...
pub fn run(sketch: String, reads: String, procs: i32, ranks: usize, index_size: usize, sketch_size: usize) -> Result<(), Error> {
    ...
    */
    ...
    let mash_args = ["dist", "-p", &*format!("{}", procs), "-l", &*format!("{}", sketch), &*format!("{}", reads)];
    ...
    compute_ssh(reader, tail_index, index_size, ranks);
